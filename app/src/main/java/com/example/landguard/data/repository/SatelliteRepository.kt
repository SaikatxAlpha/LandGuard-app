...
class SatelliteRepositoryImpl @Inject constructor() : SatelliteRepository {
    ...
    private val scenes = listOf(
        SatelliteScene(
            id = "alos4_palsar3_20260907",
            source = com.example.landguard.domain.model.SatelliteSource.ALOS4_PALSAR3,
            layer = com.example.landguard.domain.model.SatelliteLayer.ALOS4_INSAR_DISPLACEMENT,
            acquisitionDate = "2026-09-07 14:22 UTC",
        ...
        SatelliteScene(
            id = "sentinel2_msi_20260908",
            source = com.example.landguard.domain.model.SatelliteSource.SENTINEL2_MSI,
            layer = com.example.landguard.domain.model.SatelliteLayer.SENTINEL2_NDVI,
            acquisitionDate = "2026-09-08 05:18 UTC",
    ...
    private val deformationPoints = listOf(
        GroundDeformationPoint(
            ...
            lastScanDate = "2026-09-07 (ALOS-4 PALSAR-3)",
            slopeAngleDegrees = 38.2
        ),
        GroundDeformationPoint(
            id = "def_02",
            label = "Observatory Hill Slope - Darjeeling",
            latitude = 27.0410,
            longitude = 88.2630,
            ...
            lastScanDate = "2026-09-07 (ALOS-4 InSAR)",
        ...
        GroundDeformationPoint(
            ...
            lastScanDate = "2026-09-08 (ALOS-4 + Sentinel-2)",
        ...
        GroundDeformationPoint(
            ...
            lastScanDate = "2026-09-08 (Sentinel-2 MSI)",
    ...
    private val overpasses = listOf(
        ...
        SatelliteOverpass(
            ...
            expectedTime = "Tomorrow, 05:22 UTC",
    ...
    override suspend fun updateApiConfig(config: SatelliteApiConfig): Result<Unit> {
        return try {
    ...
    override suspend fun refreshSatelliteFeeds(): Result<Unit> {
